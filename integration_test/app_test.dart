import 'package:budget_sales/app/app_widget.dart';
...
Future<void> launchAppToAuth(WidgetTester tester,
...
void main() {
  ...
  testWidgets(
    ...
    expect(
      tester.any(find.text('Orçamento de Vendas')) ||
  ...
  testWidgets(
    ...
    Modular.to.navigate(
        '/cashierstatementsummary/desktop/cashierstatementsummary/monthly/');
    await tester.pump();
